...
- 풀이한 문제
  - Python: 10828(스택), 10773(제로), 9012(괄호), 4949(균형잡힌 세상), 1874(스택 수열), 5397(키로거), 1662(압축)
  - Java: 10828(스택), 10773(제로), 9012(괄호), 4949(균형잡힌 세상), 1874(스택 수열), 5397(키로거), 1662(압축)
...
- 풀이한 문제
  - Python: 11279(최대 힙), 1927(최소 힙), 11286(절댓값 힙), 2220(힙 정렬), 1655(가운데를 말해요) - 최대 힙, 최소 힙 2개 사용, 1715(카드 정렬하기), 1766(문제집)
  - Java: 11279(최대 힙), 1927(최소 힙), 11286(절댓값 힙), 2220(힙 정렬), 1715(카드 정렬하기), 1766(문제집)
...
- 풀이한 문제
  - Python: 10872(팩토리얼), 10870(피보나치 수 5), 11729(하노이 탑 이동 순서), 2447(별찍기 - 10), 1991(트리 순회), 6603(로또), 2448(별찍기 - 11), 1662(압축), 2800(괄호 제거), 9997(폰트)
  - Java: 10872(팩토리얼), 10870(피보나치 수 5), 11729(하노이 탑 이동 순서), 2447(별찍기 - 10), 1991(트리 순회), 6603(로또), 2448(별찍기 - 11), 1662(압축), 2800(괄호 제거), 9997(폰트)
  
### Dynamic Programming
큰 문제를 작은 여러 개의 문제로 나누어 푸는 기법으로 작은 문제를 풀어 값을 저장해 두었다가 반복되는 큰 문제에 재사용하는 기법

- 풀이한 문제
  - Python: 1904(01타일), 12865(평범한 배낭), 11053(가장 긴 증가하는 부분 수열)
  - Java: 1904(01타일), 12865(평범한 배낭), 11053(가장 긴 증가하는 부분 수열)
